const createFooter = () => {
    ...
    <div class="footer-content">
        ...
        <div class="footer-ul-container">
            ...
            <ul class="category">
                ...
                <li><a href="#" class="footer-link">trrrrr</a></li>
                <li><a href="#" class="footer-link">ma lgyt ma nekteb</a></li>
    ...
    <p class="info">ok baby yeah we will do it ... description aandkom louled eketbou chthebou .... papam papam papam papam papam </p>
